resumo = "Paloma é uma mulher de 46 anos que está querendo mudar de carreira, por isso está estudando 'Python'."
...
idade = 46
print(f"Paloma é uma mulher de {idade} anos que está querendo mudar de carreira, por isso está estudando 'Python'.")
